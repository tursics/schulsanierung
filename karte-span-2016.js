...
//		console.log(e);
	...
	$('#autocomplete').autocomplete({
		...
		noSuggestionNotice: '<i class="fa fa-info-circle" aria-hidden="true"></i> Sie können hier nur nach Schulen aus Spandau suchen'
	});
}
...
function initMap(elementName, lat, lng, zoom) {
	...
	if (null === map) {
		var mapboxToken = 'pk.eyJ1IjoidHVyc2ljcyIsImEiOiI1UWlEY3RNIn0.U9sg8F_23xWXLn4QdfZeqg',
			...
			dataUrl = 'data/gebaeudescan2016-span.json';
